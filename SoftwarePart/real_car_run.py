...
grid_MAP_SIZE_PIXELS = 600
grid_MAP_SIZE_METERS = 10
...
parser.add_argument("--half-wheelbase", type=float, default=0.0995, help="半轮距(米)")
parser.add_argument("--cpr", type=int, default=1395, help="编码器CPR")
...
def main():
    ...
    #初始化slam
    slam = Deterministic_SLAM(laser, grid_MAP_SIZE_PIXELS, grid_MAP_SIZE_METERS,hole_width_mm=200)
